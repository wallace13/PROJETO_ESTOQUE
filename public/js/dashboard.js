...
function GraficoColuna(ctx, data) {
  var myChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        data: data,
        backgroundColor: ['rgba(158, 197, 254, 1)',
        //Azul
        'rgba(241, 174, 181, 1)' //Vermelho
        ],
        borderColor: ['rgba(158, 197, 254, 1)',
        //Azul
        'rgba(241, 174, 181, 1)' //Vermelho
        ],
        borderWidth: 1
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GraficoColuna);

/***/ }),

/***/ "./resources/js/graficoPizza.js":
/*!**************************************!*\
  !*** ./resources/js/graficoPizza.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function GraficoPizza(ctx, data) {
  var porcentagens = calcularPorcentagens(data);
  var myChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart(ctx, {
    type: 'pie',
    data: {
      labels: ['Entradas', 'Saidas'],
    ...
    options: {
      plugins: {
        // Adicione esta seção para exibir o símbolo de porcentagem nos rótulos
        tooltip: {
          callbacks: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GraficoPizza);
...
/*!***********************************!*\
  ...
  \***********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _graficoColuna__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./graficoColuna */ "./resources/js/graficoColuna.js");
/* harmony import */ var _graficoPizza__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./graficoPizza */ "./resources/js/graficoPizza.js");


var dadosGraficoEntradaSaida = {
  data: []
};
var graficoColunaEntradaSaida = null;
var graficoPizzzaEntradaSaida = null;
var entradas = document.getElementById('entradas').innerText;
var saidas = document.getElementById('saidas').innerText;
dadosGraficoEntradaSaida.data = [entradas, saidas];

// Gráfico de coluna - Entrada/Saida
var colunaEntradaSaida = document.getElementById('colunaEntradaSaida').getContext('2d');
graficoColunaEntradaSaida = (0,_graficoColuna__WEBPACK_IMPORTED_MODULE_0__["default"])(colunaEntradaSaida, dadosGraficoEntradaSaida.data);

// Criação do gráfico de pizza Entrada/Saida
var pizzaEntradaSaida = document.getElementById('pizzaEntradaSaida').getContext('2d');
graficoPizzzaEntradaSaida = (0,_graficoPizza__WEBPACK_IMPORTED_MODULE_1__["default"])(pizzaEntradaSaida, dadosGraficoEntradaSaida.data);
})();
